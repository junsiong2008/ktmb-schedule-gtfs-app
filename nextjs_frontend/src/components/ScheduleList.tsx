                            ...
                            {items.map((item, index) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-900">{item.trip_id}</p>
                                            <p className="text-xs text-gray-500">{item.station_name}</p>
                                        </div>
                                    </div>

                                    <div className="flex items-center gap-6">
                                        <div className="text-right">
                                            <p className="text-sm font-medium text-gray-900">{item.departure_time.substring(0, 5)}</p>
                                            <p className="text-xs text-gray-500">Departure</p>
                                        </div>
                                        <div className="text-right hidden sm:block">
                                            <p className="text-sm font-medium text-gray-900">{item.arrival_time.substring(0, 5)}</p>
